...
scenarios: ["帮我做个startup canvas", "新产品把战略和商业模式一起捋下", "评估下这个创业概念"]
---
# Startup Canvas
...
Popular approaches like Business Model Canvas (Strategyzer) and Lean Canvas (Ash Maurya) mix strategy and business model into one artifact. The **Startup Canvas** separates them: 9 strategy sections from the Product Strategy Canvas + Cost Structure & Revenue Streams.
