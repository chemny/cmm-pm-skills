...
> **Boundary:** This is a specialist method, not a complete MRD/market-analysis stage. When invoked inside a stage, inherit the stage wrapper and `main/references/contracts/deep-research-contract.md`; do not mark the stage complete from this leaf skill alone.
